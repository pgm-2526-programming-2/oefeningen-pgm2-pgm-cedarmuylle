function logProcessingReport(data) {
...
function logStatisticsReport(data, [highImportanceCount, lowImportanceCount]) {
...
function logComplexitySummary(data, [highComplexityCount, lowComplexityCount]) {
...
module.exports = { logProcessingReport, logStatisticsReport, logComplexitySummary };